...
2. **Covered accounts.** Team email(s), WildApricot, cloud storage, social media, **Stanford Federal Credit Union online banking** (business checking), and any other platform used for CAN.dy operations.

3. **Ownership/admin rules.**
- Accounts should be registered to the Team primary email whenever possible.
- Both Co-Directors must have admin access to core platforms (WildApricot + all social channels).
